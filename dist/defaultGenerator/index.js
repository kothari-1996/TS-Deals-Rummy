...
function defaultUserProfile(userData) {
...
function defaultTableGamePlayData(roundId, gameType) {
    const currentTimestamp = new Date();
    const data = {
        _id: ObjectId().toString(),
        roundId,
...
function defaulPlayerGamePlayData(userObjectId, seatIndex, roundId, isRejoin) {
    const currentTimestamp = new Date();
    const data = {
        _id: ObjectId().toString(),
        userObjectId,
